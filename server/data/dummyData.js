...
var cityZips = [
  ...
  {city: 'Maple Grove', zip: '55311'}, {city: 'Medina', zip: '55340'}, {city: 'Long Lake', zip: '55356'}, {city: 'Maple Plain', zip: '55359'}, {city: 'Mound', zip: '55364'}, {city: 'Maple Grove', zip: '55369'},
...
var cityCounties = [
  {city: 'Afton', county: 'Washington'},
  {city: 'Cottage Grove', county: 'Washington'},
  {city: 'Farmington', county: 'Dakota'},
  {city: 'Hastings', county: 'Dakota'},
  {city: 'Lakeland', county: 'Washington'},
  {city: 'Lakeville', county: 'Dakota'},
  {city: 'Newport', county: 'Washington'},
  {city: 'Rosemount', county: 'Dakota'},
  {city: 'Saint Paul Park', county: 'Washington'},
  {city: 'Inver Grove Heights', county: 'Dakota'},
  {city: 'Mendota Heights', county: 'Dakota'},
  {city: 'Eagan', county: 'Dakota'},
  {city: 'Apple Valley', county: 'Dakota'},
  {city: 'Woodbury', county: 'Washington'},
  {city: 'Burnsville', county: 'Dakota'},
  {city: 'Chanhassen', county: 'Carver'},
  {city: 'Chaska', county: 'Carver'},
  {city: 'Cologne', county: 'Carver'},
  {city: 'Prior Lake', county: 'Scott'},
  {city: 'St. Bonifacius', county: 'Hennepin'},
  {city: 'Savage', county: 'Scott'},
  {city: 'Shakopee', county: 'Scott'},
  {city: 'Victoria', county: 'Carver'},
  {city: 'Waconia', county: 'Carver'},
  {city: 'Maple Grove', county: 'Hennepin'},
  {city: 'Medina', county: 'Hennepin'},
  {city: 'Long Lake', county: 'Hennepin'},
  {city: 'Maple Plain', county: 'Hennepin'},
  {city: 'Mound', county: 'Hennepin'},
  {city: 'Rogers', county: 'Hennepin'},
  {city: 'Spring Park', county: 'Hennepin'},
  {city: 'Wayzata', county: 'Hennepin'},
  {city: 'Minneapolis', county: 'Hennepin'},
  {city: 'Robbinsdale', county: 'Hennepin'},
  {city: 'Golden Valley', county: 'Hennepin'},
  {city: 'Brooklyn Park', county: 'Hennepin'},
  {city: 'Plymouth', county: 'Hennepin'},
  {city: 'Minnetonka', county: 'Hennepin'},
  {city: 'Eden Prairie', county: 'Hennepin'},
  {city: 'Bloomington', county: 'Hennepin'},
  {city: 'Edina', county: 'Hennepin'},
  {city: 'Bethel', county: 'Anoka'},
  {city: 'Oak Grove', county: 'Anoka'},
  {city: 'Circle Pines', county: 'Anoka'},
  {city: 'St. Francis', county: 'Anoka'},
  {city: 'Wyoming', county: 'Chisago'},
  {city: 'Andover', county: 'Anoka'},
  {city: 'Champlin', county: 'Hennepin'},
  {city: 'Coon Rapids', county: 'Anoka'},
  {city: 'Blaine', county: 'Ramsey'},
  {city: 'Forest Lake', county: 'Washington'},
  {city: 'Hugo', county: 'Washington'},
  {city: 'Lake Elmo', county: 'Washington'},
  {city: 'Marine on St. Croix', county: 'Washington'},
  {city: 'Scandia', county: 'Washington'},
  {city: 'Stillwater', county: 'Washington'},
  {city: 'North St. Paul', county: 'Ramsey'},
  {city: 'White Bear Lake', county: 'Ramsey'},
  {city: 'Mahtomedi', county: 'Washington'},
  {city: 'St. Paul', county: 'Ramsey'},
  {city: 'South St. Paul', county: 'Dakota'},
  {city: 'Arden Hills', county: 'Ramsey'},
  {city: 'Roseville', county: 'Ramsey'},
  {city: 'Shoreview', county: 'Ramsey'},
  {city: 'Brooklyn Center', county: 'Hennepin'},
