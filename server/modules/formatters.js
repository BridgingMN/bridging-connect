...
function formatSingleAppointment(appointment) {
  appointment.info.start_time = formatTimeForClient(appointment.info.start_time);
  appointment.info.end_time = formatTimeForClient(appointment.info.end_time);
  return appointment;
}
